...
HW3P3 slist-(llist.cpp)
Your name: Jer Cherng Law
Complier : Xcode g++ 4.2.1
File type: Implementation file for linked list in hw3p3
Additional notes: Display function has been upgraded to better suit the output needs.
                  cout has been moved from implementation file to test file in order
                  to output the name of list being displayed.
======================================================================================
*/
#include"llist.h" 
...
void llist::displayAll()
{
    ...
    if(this->isEmpty()) cout << setfill(' ') << setw(20) << "(Empty linked list) ";
